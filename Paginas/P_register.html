...
<html lang="en">
    <head>
        ...
        <title>UTP CLINICA/REGISTRO</title>
        <!-- logo-->
        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-3">Registrate</h2>
              <?php 
              ...
              <form id="register-form" class="form" action="process2.php" method="post">
               ...
               <div class="form-outline mb-4">
                ...
                <div class="d-flex justify-content-center">
                  <input type="submit" name="Register" class="btn btn-info btn-md" value="Registrarse">
                </div>

                <p class="text-center text-muted mt-3 mb-0">Ya tienes Cuenta? <a href="login.php" class="fw-bold text-body"><u>Iniciar Sesion</u></a></p>
              </form>
